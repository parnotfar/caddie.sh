...
- **`ledger`**: Agentic checkpoint capsules with local provenance and optional Supabase sync
...
Each module exposes an `info` command for quick environment summaries.
