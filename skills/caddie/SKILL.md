...
3. **Inspect one command** — Participating modules support both `caddie <module>:<command> --help` and `caddie <module>:<command>:help`. If neither is available, use the module-level help.
